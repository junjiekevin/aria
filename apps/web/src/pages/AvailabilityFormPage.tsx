...
export default function AvailabilityFormPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const availabilityChoices = timings.slice(0, maxChoices).map((t) => {
                const base = new Date();
            ...
            if (availabilityError) {
                throw new Error(`Failed to submit availability: ${availabilityError.message}`);
            }
