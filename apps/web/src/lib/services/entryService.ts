...
// COMPATIBILITY-ONLY (BLD-001, BLD-012): schedule_entries service with no active callers
// from canonical assistant or calendar event paths as of BLD-012.
// Remaining callers: AddEventModal, SchedulePage (compatibility-only pages).
// New v2.1 calendar workspace writes belong in packages/application and packages/infrastructure.
