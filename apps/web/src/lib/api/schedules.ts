...
// COMPATIBILITY-ONLY (BLD-001, BLD-012): direct schedules table gateway with no active
// callers from canonical assistant or calendar event paths as of BLD-012.
// Remaining callers: scheduleService.ts (compatibility-only), DashboardPage, SchedulePage.
// New v2.1 canonical event persistence belongs in packages/infrastructure.
