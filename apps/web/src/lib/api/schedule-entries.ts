...
// COMPATIBILITY-ONLY (BLD-001, BLD-012): direct schedule_entries CRUD with no active
// callers from canonical assistant or calendar event paths as of BLD-012.
// Remaining callers: entryService.ts (compatibility-only), autoScheduler.ts.
// New v2.1 event persistence belongs in packages/infrastructure.
