...
- **Data Security** -- Row Level Security (RLS) policies enforce strict tenant isolation at the database level. The AI assistant operates exclusively within the authenticated user's session.
